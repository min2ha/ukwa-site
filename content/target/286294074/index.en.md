{
  ...
  "open_access": true, 
  "target_url": "http://shawweb.myzen.co.uk/stephen/", 
  "description": "<p>Stephen's Home Page contains text of books 'History of St Thomas Church, Heaton Norris' and 'Getting Started with the TI99/4A computer', Sample programs in sdlbasic, catalogue from ceased firm 'Stainless Software', reference page for disappeared film 'Magic Boy', reference page for local demolished historic cinema (Poco a Poco) with additional supporting reference pages.</p>\n", 
  "end_date": null, 
  "title": "Stephen's Home Page", 
  "record_id": "20150113T000000/9mnfctTBKedNM00CLXSryA==", 
  "publisher": "myzen.co.uk", 
