...
Longer term, it would make sense to move this site to a JavaScript framework, in particular one of the modern ones that make it easy to mix statically-generated, server-generated, and client-side deployment:
